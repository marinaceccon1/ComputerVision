...
#全局变量进行路径配置
label_folder = '/content/labels'  #检测结果存放文件夹labels路径

raw_images_folder = '/content/raw_images'  #检查图片存放文件夹raw_images路径

save_images_folder = '/content/save_image'  #保存图片文件夹save_image路径

name_list_path = '/content/name_list.txt'  #里面有检测图片名称txt文件路径
